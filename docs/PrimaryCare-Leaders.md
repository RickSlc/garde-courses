...
<li style="margin-bottom:22px;">
GARDE includes a chatbot authoring platform (<a href="https://garde.utah.edu/what-is-garde-chat.html">GARDE-Chat</a>) for patient outreach, education, and healthcare service facilitation.
</li>
...
GARDE can be used in both research and clinical settings. Additional use cases can be found [here](https://garde.utah.edu/potential-use-cases.html). 
...
If you want to download this information, just click [here](resources/pdfs/Primary care line leaders.pdf){target="_blank"} for a pdf!
